...
test.describe("Bond Protocol", () => {
    test("Should create Fixed Term market", async ({ page, gui }) => {
        ...
        await gui.setAllowance("0x6b175474e89094c44da98b954eedeac495271d0f", "0x007f7735baf391e207e3aa380bb53c4bd9a5fed6", "100000000000000000000000");
        ...
        await gui.validateContractInteraction("button[id='cm-confirm-modal-submit']", "0x007F7A1cb838A872515c8ebd16bE4b14Ef43a222");
    });
});
