...
test.describe("Bond Protocol", () => {
    test("Should approve teller to create Fixed Expiry market", async ({ page, gui }) => {
        // Initialize fork
        ...
        await gui.validateContractInteraction("button[id='cm-confirm-modal-submit-allowance']", "0x007fe70dc9797c4198528ae43d8195fff82bdc95");
    });
});
