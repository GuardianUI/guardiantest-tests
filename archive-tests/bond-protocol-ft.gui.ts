...
test.describe("Bond Protocol Demo", () => {
    test("Should use Bond Protocol's app", async ({ page, gui }) => {
        ...
        page.route("**/*", async (route, request) => {
            if (request.method() === "POST") {
                ...
                if (postData.method === "eth_estimateGas") {
                    console.log("mocking eth_estimateGas");
        ...
        await gui.setAllowance("0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", "0x007f7735baf391e207e3aa380bb53c4bd9a5fed6", "1000000000000000000000000");
